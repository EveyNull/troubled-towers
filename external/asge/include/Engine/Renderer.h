...
namespace ASGE {
	...
	*/
	...
	public:
		...
		*/
		explicit Renderer(RenderLib render_lib)
			: lib(render_lib) {}
		...
		*/
		virtual void renderText(std::string str, int x, int y, float scale, const Colour& colour, float z_order) = 0;
		...
		*  @param [in] colour The colour to use for rendering.
		*/
		void renderText( std::string str, int x, int y, float scale, const Colour& colour);
